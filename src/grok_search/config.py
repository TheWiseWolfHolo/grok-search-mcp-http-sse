...
class Config:
    ...
    @property
    def search_include_query_diagnostic(self) -> bool:
        return os.getenv("GROK_SEARCH_INCLUDE_QUERY_DIAGNOSTIC", "true").lower() in ("true", "1", "yes")
    ...
    @property
    def search_empty_result_retry_relax_min_score(self) -> float:
        raw = os.getenv("GROK_SEARCH_EMPTY_RESULT_RETRY_RELAX_MIN_SCORE", "0.08")
        try:
            value = float(raw)
        except ValueError:
            return 0.08
    ...
    @property
    def search_empty_result_retry_extra_low_quality_quota(self) -> int:
        raw = os.getenv("GROK_SEARCH_EMPTY_RESULT_RETRY_EXTRA_LOW_QUALITY_QUOTA", "1")
        try:
            value = int(raw)
        except ValueError:
            return 1
    ...
    def get_config_info(self) -> dict:
        ...
        return {
            ...
            "GROK_SEARCH_INCLUDE_QUERY_DIAGNOSTIC": self.search_include_query_diagnostic,
